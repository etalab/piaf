...
class Seq2seqAnnotationResponse(models.Model):
    seq2seqAnnotation = models.ForeignKey(
        Seq2seqAnnotation,
        related_name="seq2seq_annotations_response",
...
class QandAAnnotation(Annotation):
    ...
    document = models.ForeignKey(
        Document, related_name="qanda_annotations", on_delete=models.CASCADE
    )
    response = models.TextField()
    start_offset = models.IntegerField()
