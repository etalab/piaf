<template>
  <v-tooltip left v-bind:open-on-click=true open-delay=1000>
    ...
    <span><strong>"{{currentDocument.title}}"</strong> est le titre de l'article Wikipédia dont est issu le paragraphe ci-dessous que vous allez annoter.<br>
